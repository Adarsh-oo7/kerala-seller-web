...
const data = FOR_PAGES['social-media-sellers'];
const PAGE_URL = `${BRAND.url}/for/social-media-sellers`;
    ...
    '@graph': [
      {
        ...
        breadcrumb: {
          ...
          itemListElement: [
            ...
            { '@type': 'ListItem', position: 3, name: 'Social Media Sellers', item: PAGE_URL },
          ],
        },
      },
      {

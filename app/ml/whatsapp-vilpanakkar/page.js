...
export default function MlPage() {
  return (
    <SeoPageLayout breadcrumbs={[{ label: 'Home', href: '/' }, { label: 'ML', href: '/ml' }, { label: 'വാട്സ്ആപ്പ് വിൽപനക്കാർ' }]}>
      ...
      <section className="seo-hero" aria-labelledby="ml-whatsapp-vilpanakkar-h1">
        <div className="seo-hero__inner">
          <div className="seo-hero__badge">🌿 Malayalam | മലയാളം</div>
          <h1 className="seo-hero__h1" id="ml-whatsapp-vilpanakkar-h1" lang="ml">വാട്സ്ആപ്പ് ഓർഡറുകൾ എളുപ്പത്തിൽ മാനേജ് ചെയ്യാം</h1>
          <p className="seo-hero__sub" lang="ml">WhatsApp Status-ൽ സ്റ്റോർ ലിങ്ക് ഇടൂ. ഉപഭോക്താക്കൾ ക്ലിക്ക് ചെയ്ത് ഓർഡർ ചെയ്യും — ഒരു DM പോലും ആവശ്യമില്ല.</p>
          <div className="seo-hero__cta">
            <Link href="/register/seller" className="seo-btn-primary" id="ml-whatsapp-vilpanakkar-start-btn">🏪 Start Your Free Store →</Link>
            <Link href="/for/whatsapp-sellers" className="seo-btn-secondary">WhatsApp Sellers (English)</Link>
          </div>
        </div>
      </section>

...
const s = {
  ...
  modal: { backgroundColor: 'white', borderRadius: '12px', padding: '24px', maxWidth: '500px', width: '90%', boxShadow: '0 10px 40px rgba(0,0,0,0.2)', animation: 'slideIn 0.3s ease-out' },
  ...
  infoBox: { display: 'flex', gap: '12px', padding: '12px', backgroundColor: '#eff6ff', border: '2px solid #bfdbfe', borderRadius: '8px', marginBottom: '20px', fontSize: '13px', color: '#1e40af' },
  ...
  input: { padding: '10px 12px', border: '2px solid #e5e7eb', borderRadius: '6px', fontSize: '13px', outline: 'none' },
  ...
  cancelBtn: { padding: '12px', backgroundColor: '#f3f4f6', color: '#374151', border: 'none', borderRadius: '6px', cursor: 'pointer', fontSize: '14px', fontWeight: 600 },

  ...
  return (
    <div style={{ backgroundColor: "#FDFFF0", minHeight: '100vh' }}>
      ...
      <div style={dynamicStyles.container} data-products-section>
        <nav aria-label="Breadcrumb" style={{ marginBottom: 10, fontSize: 14, color: '#64748b' }}>
          <Link href="/" style={{ color: '#1a4845', textDecoration: 'none' }}>Home</Link>
          <span>{' / '}</span>
          <span>Products</span>
        </nav>
        <p style={{ margin: '0 0 16px', color: '#4b5563', fontSize: '0.95rem', lineHeight: 1.5, maxWidth: 720 }}>
          Buy from Kerala shops selling clothes, jewellery, bakery, homemade food, and local goods.
          These listings come from sellers who already take orders on Instagram and WhatsApp.
        </p>
        ...
        <div style={dynamicStyles.searchSection}>
         ...
         <div style={dynamicStyles.productsHeader}>
          <div style={dynamicStyles.headerLeft}>
            <h1 className='keralasellershomepagetitle' style={dynamicStyles.sectionTitle}>Products from Kerala sellers</h1>
            {searchTerm && (
